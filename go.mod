...
require github.com/duke-git/lancet/v2 v2.1.13 // indirect

require (
	github.com/duke-git/lancet v1.3.5
...
replace (
	//cloud.google.com/go/compute/metadata => cloud.google.com/go/compute/metadata v0.81.0
